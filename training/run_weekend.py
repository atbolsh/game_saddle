...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--parallel", type=int, default=12,
                    help="concurrent datagen sessions per epoch (passed to "
                        ...
                        "conservative path; default 12 (12-wide T~8k is "
                        "57.5 GiB; 12x12288 leftover-pad is 93.3 GiB so "
                        "T>=8700 isolates to GPU B<=3). 16 died CUBLAS "
                        "on shorter sealed games (2026-08-17)")
